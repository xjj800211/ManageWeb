<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login_List.aspx.cs" Inherits="RM.Web.RMBase.SysPersonal.Login_List" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            divresize(90);
            FixedTableHeader("#table1", $(window).height() - 118); //固定表头
        })
    </script>
</head>
<body>
